...
class GoMage_Instagram_Service {
	
	const SERVICE_ENDPOINT			= 'https://api.instagram.com/v1';
	...
	public function __construct(GoMage_Instagram_Credentials $credentials) {
	...
	public function requestUserProfile($parameters = array()) {	
		...
		$this->request(self::SERVICE_ENDPOINT . '/users/self', 'GET', $parameters);
